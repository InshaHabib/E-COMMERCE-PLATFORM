        ...
        <div className="col2 w-full lg:w-[80%]">
          <div className="shadow-md rounded-md bg-white">
            <div className="py-5 px-5 border-b border-[rgba(0,0,0,0.1)]">
              ...
              <thead class="text-xs text-gray-700 uppercase border-b dark:bg-[#f1f1f1] dark:border-white-700 border-white-200">
                    <tr>
                  ...
                  <tbody>

                    {
                      orders?.data?.length !== 0 && orders?.data?.map((order, index) => {
                        return (
                          <>
                           <tr className="bg-white border-b dark:bg-white dark:border-white-700 border-white-200">
                                          ...
                                          order?.products?.map((item, index) => {
                                            return (
                                              <tr className="bg-white border-b dark:bg-white dark:border-white-700 border-white-200">
                                                ...
                                                <td className="px-6 py-4 font-[500]">{item?.price?.toLocaleString('en-US', { style: 'currency', currency: 'PKR' })}</td>

                                                <td className="px-6 py-4 font-[500]">{(item?.price * item?.quantity)?.toLocaleString('en-US', { style: 'currency', currency: 'PKR' })}</td>
                                              </tr>
                                            )
                                          })
                                        }
